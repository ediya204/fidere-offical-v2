...
export const metadata = pageMetadata("en", "compliance/source-of-funds", topic.title[0], topic.description[0]);

export default function Page() {
  return <ComplianceTopic locale="en" slug="source-of-funds" />;
}
